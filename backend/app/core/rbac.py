...
PERMISSION_RUNTIME_READ = "runtime.read"
PERMISSION_SECURITY_EVENTS_READ = "security.events.read"
PERMISSION_DATABASE_RECOVERY_READ = "database.recovery.read"
PERMISSION_DATABASE_RECOVERY_MANAGE = "database.recovery.manage"
